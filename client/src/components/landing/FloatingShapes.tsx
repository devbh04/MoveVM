...
export const FloatingShapes: React.FC = () => {
  const shapes = [
    ...
    { id: 2, size: 'w-16 h-16', color: 'bg-gradient-to-br from-yellow-500 to-pink-600', x: '85%', y: '15%' },
    ...
    { id: 5, size: 'w-18 h-18', color: 'bg-gradient-to-br from-indigo-500 to-yellow-600', x: '50%', y: '10%' },
